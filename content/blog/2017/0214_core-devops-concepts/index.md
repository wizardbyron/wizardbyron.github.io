...
在[**\#DevOps的前世今生\# 2. Dev和Ops矛盾缘何而来？**](/blog/2017/0127_where-did-devops-issues-come)一文中，通过Dev和Ops的历史发展总结出了Dev和Ops矛盾的历史渊源，以及 Dev 和 Ops 的核心矛盾：
...
**拉近软件开发和系统工程的交互**：采用敏捷团队或者其他形式的多功能团队跨越不同的部门墙。
